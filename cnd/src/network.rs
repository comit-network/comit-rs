...
impl ComitNode {
    ...
    pub fn initiate_communication(
        ...
        self.comit_ln
            .initiate_communication(local_swap_id, peer, role, digest, comit_ln::Data {
                secret,
                shared_swap_id,
                local_ethereum_identity: Some(ethereum_identity.into()),
                local_lightning_identity: Some(lightning_identity),
                ..Default::default()
            })
    }
