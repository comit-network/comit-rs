...
fn create_btsieve_api_client(settings: &Config) -> BtsieveHttpClient {
...
fn spawn_comit_i_instance(settings: Config, runtime: &mut tokio::runtime::Runtime) {
...
fn auth_origin(settings: &Config) -> String {
