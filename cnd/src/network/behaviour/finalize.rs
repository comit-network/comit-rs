use crate::network::protocol::finalize::{InboundProtocolConfig, Message, OutboundProtocolConfig};
use libp2p::{
...
/// Network behaviour that handles the finalize protocol.
#[derive(Debug)]
...
pub enum OutEvent {
    Received(Message), // OutEvent containing finalize message.
