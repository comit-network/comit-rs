use crate::network::protocol::bitcoin::{InboundProtocolConfig, Message, OutboundProtocolConfig};
use libp2p::{
...
/// Network behaviour that handles the bitcoin identity protocol.
#[derive(Debug)]
...
pub enum OutEvent {
    Received(Message), // OutEvent containing bitcoin identity message.
