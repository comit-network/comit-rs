use crate::network::protocol::ethereum::{InboundProtocolConfig, Message, OutboundProtocolConfig};
use libp2p::{
...
/// Network behaviour that handles the ethereum identity protocol.
#[derive(Debug)]
...
pub enum OutEvent {
    Received(Message), // OutEvent containing ethereum identity message.
