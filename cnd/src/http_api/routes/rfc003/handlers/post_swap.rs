use crate::{
    ...
    swap_protocols::{
        ledger::{self},
        rfc003::{
            self, alice::State, state_store::StateStore, Accept, Decline, DeriveIdentities,
            DeriveSecret, Ledger, Request, SecretHash,
        },
...
where
    ...
    AA: Asset,
    BA: Asset,
    Facade: LoadAcceptedSwap<AL, BL, AA, BA>, /*        + HtlcFunded<AL, AA>
                                               *        + HtlcFunded<BL, BA>
                                               *        + HtlcDeployed<AL, AA>
                                               *        + HtlcDeployed<BL, BA>
                                               *        + HtlcRedeemed<AL, AA>
