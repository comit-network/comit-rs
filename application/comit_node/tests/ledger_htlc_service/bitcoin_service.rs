...
use comit_node::{
    bitcoin_fee_service::{self, BitcoinFeeService},
    swap_protocols::{
        ledger::Bitcoin,
        rfc003::{bitcoin, Secret, SecretHash},
    },
    swaps::common::SwapId,
};
...
impl LedgerHtlcService<Bitcoin, BitcoinQuantity, BitcoinHtlcFundingParams, BitcoinHtlcRedeemParams>
    for BitcoinService
{
    fn deploy_htlc(
        &self,
    ...
    fn fund_htlc(
        &self,
        target: bitcoin_support::Address,
