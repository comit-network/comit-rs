use crate::{
    ...
    swap_protocols::{
        ...
        rfc003::{self, bob::BobSpawner, state_store::StateStore, CreateLedgerEvents},
        swap_id::SwapId,
        LedgerEventDependencies, LedgerKind, SwapProtocol,
    },
};
use bam::{
    self,
...
impl<T: MetadataStore<SwapId>, S: StateStore> Server
    for swap_protocols::bob::ProtocolDependencies<T, S>
{
    fn handle_request(
        &self,
...
fn handle_request<AL: rfc003::Ledger, BL: rfc003::Ledger, AA: Asset, BA: Asset, B: BobSpawner>(
    bob_spawner: &B,
    swap_id: SwapId,
    alpha_ledger: AL,
    beta_ledger: BL,
