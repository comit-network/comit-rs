...
### Changed
- Upgrade `blockchain-contracts` crate to 0.2.0. Ether and Erc20 HTLCs now use `revert` to fail the Ethereum transaction if the redeem or refund are unsuccessful.
