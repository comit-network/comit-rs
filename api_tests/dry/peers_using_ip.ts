...
setTimeout(async function() {
    twoActorTest("alice-empty-peer-list", async function({ alice }) {
    ...
    threeActorTest("alice-send-request-wrong-peer-id", async function({
        alice,
        bob,
        charlie,
    }) {
    ...
    threeActorTest("alice-send-swap-request-to-charlie", async function({
        alice,
        bob,
        charlie,
    }) {
