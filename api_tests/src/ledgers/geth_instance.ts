...
import { existsAsync, mkdirAsync, openAsync, writeFileAsync } from "../utils";
    ...
    public async start() {
        ...
        this.process = spawn(
            ...
            [
                ...
                `--password=password.txt`, // even though this file does not exist, this seems to be neccessary to enable enable the dev account
