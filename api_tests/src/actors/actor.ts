...
export class Actor {
     ...
     * @param create
     */
    public async createHerc20HalbitSwap(create: Herc20HalbitCreate) {
        this.alphaLedger = {
        ...
        this.alphaAsset = {
            ...
            tokenContract: create.alpha.contract_address,
        };
        this.betaAsset = {
        ...
        const location = await this.cnd.createHerc20Halight(create);
     ...
     * @param create
     */
    public async createHalbitHerc20Swap(create: HalbitHerc20Create) {
        this.alphaLedger = {
            name: LedgerKind.Lightning,
        ...
        this.betaAsset = {
            ...
            quantity: create.beta.amount,
            ledger: LedgerKind.Ethereum,
            tokenContract: create.beta.contract_address,
        };

        await this.setStartingBalances();

        const location = await this.cnd.createHalightHerc20(create);
     ...
     * @param create
     */
    public async createHerc20HbitSwap(create: Herc20HbitCreate) {
        this.alphaLedger = {
            name: LedgerKind.Ethereum,
            chain_id: create.alpha.chain_id,
        };
     ...
     * @param create
     */
    public async createHbitHerc20Swap(create: HbitHerc20Create) {
        this.alphaLedger = {
            name: LedgerKind.Bitcoin,
            network: create.alpha.network,
        };
