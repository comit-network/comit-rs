...
impl Erc20Offsets {
    pub fn new() -> Self {
        Erc20Offsets {
            ...
            contract_body: compile(
                "./src/bin/calculate_offsets/ethereum/rfc003/templates/erc20_contract.asm",
            )
            .unwrap(),
        }
    }
    ...
    pub fn all_offsets(&self) -> Vec<Offset> {
        ...
        let amount = self.get_offset(DataName::TokenQuantity, AMOUNT_REGEX);
        let token_contract_address =
            self.get_offset(DataName::TokenContract, TOKEN_CONTRACT_ADDRESS_REGEX);
