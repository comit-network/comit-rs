...
ENV SOLC_BIN=solc
WORKDIR /source
ENV SRC_FOLDERS="bitcoin_rpc ethereum_htlc trading_service bitcoin_wallet ethereum_wallet ganache_rust_web3 btc_htlc common_types exchange_service jsonrpc fake_treasury_service trading_client"
...
COPY btc_htlc/Cargo.toml /source/btc_htlc/Cargo.toml
