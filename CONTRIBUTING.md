...
First, please check that no user has already reported the same problem by [searching issues](https://github.com/tenx-tech/swap/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc).

To report the bug, just head over to the [create issue](https://github.com/tenx-tech/swap/issues/new/choose) page.
...
For changes related to our implementation, please [create a feature request](https://github.com/tenx-tech/swap/issues/new/choose) and follow the GitHub template.
